<?php 
 ...
 <div class="panel panel-info">
        <div class="panel-heading" id="test">Live data prediction for <a href="index.php?action=displayTicker&ticker=<?php echo $choosenTicker?>"><?php echo $choosenTicker?></a></div>
